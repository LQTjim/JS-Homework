...
const warning1 = document.querySelector("[data-warning-1]");
input1.addEventListener("input", () => {
    const regExp1 = /^(?=.*[A-Za-z])(?=.*\d)(?=.*[@$!%*#?&])[A-Za-z\d@$!%*#?&]{7,}$/;
...
const warning2 = document.querySelector("[data-warning-2]");
...
8位數以上、至少包含一個大寫字母、小寫字母、數字、符號
  */
//#region
const input3 = document.querySelector("[data-input-3]");
const warning3 = document.querySelector("[data-warning-3]");
const regExp3 = /^(?=.*[A-Z])(?=.*[a-z])(?=.*\d)(?=.*[@$!%*#?&])[A-Za-z\d@$!%*#?&]{8,}$/;
