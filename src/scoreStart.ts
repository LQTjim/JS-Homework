const scoreContainer: HTMLElement = document.querySelector(".score-container")!;
const stars = document.querySelectorAll("[data-index]");
const starResult: HTMLElement = document.querySelector(".star-result")!;
...
scoreContainer.addEventListener("click", (e) => {
  ...
  const dataScore = e.target as HTMLElement;
